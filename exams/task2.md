...
Finops - методология, ориентированная на оптимизацию затрат внутри организации умными способами. Она заключается в применении новейших практик, процессов и инструментов по оптимизации работы команд, затрат на вычислительные мощности. Finops опирается на данные принципы:
- Культура
- Управляемость
- Технологичность
...
В общем и целом, finops предлагает фреймворк для управления в контексте организации, применяющей современные методы разработки и доставки ПО. Так, например:
- Оптимизация расходов
- Информированное применение технологий
- Более эффективное взаимодействие со stakeholder'ами
- Оптимизация процесса принятия решений

# Вывод
  DevSecFinOps (комбинация DevSecOps, FinOps) - "наследник" концепции DevSecOps, FinOps были добавлены для оптимизации затрат на управление облаком.
